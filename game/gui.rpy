...
define gui.accent_color = u'#477B48'

## Цвет, используемый в текстовой кнопке, когда она не выбрана и не наведена.
define gui.idle_color = u'#17554C'
...
define gui.hover_color = u'#3EC3B0'

## Цвет, используемый текстовой кнопкой, когда она выбрана, но не наведена. 336600
...
define gui.text_font = "fonts/Calibri-Italic.ttf"

## Шрифт, используемый именами персонажей.
define gui.name_text_font = "fonts/RobotoSlab-VariableFont_wght.ttf"
...
define gui.button_text_font = "fonts/Neucha-Regular.ttf" #gui.interface_text_font
